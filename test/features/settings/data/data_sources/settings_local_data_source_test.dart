...
void main() {
  ...
  group('SettingsStorage', () {
    ...
    test(
      'setAllowedBadCertificateUrls and getAllowedBadCertificateUrls',
      () async {
    ...
    test(
      'getAllowedBadCertificateUrls should return empty list if not set',
      () async {
    ...
    test(
      'getAllowedBadCertificateUrls should return empty list if data is invalid',
      () async {
        const storage = FlutterSecureStorage();
        await storage.write(
          key: 'allowed_bad_cert_urls',
          value: 'invalid json',
        );
        expect(await settingsStorage.getAllowedBadCertificateUrls(), isEmpty);
      },
