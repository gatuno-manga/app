...
class UserModel {
  ...
  factory UserModel.fromJson(Map<String, dynamic> json) {
    ...
    return UserModel(
      id: UserId.fromJson(
        json['sub'] as String? ?? json['id'] as String? ?? '',
      ),
      email: UserEmail.fromJson(json['email'] as String?),
      roles: UserRoles.fromJson(json['roles'] as List<dynamic>?),
      maxWeightSensitiveContent: SensitiveContentWeight.fromJson(
        json['maxWeightSensitiveContent'] as int?,
      ),
      userName: json['username'] != null || json['userName'] != null
          ...
          : null,
      name: json['name'] != null
          ? UserDisplayName.fromJson(json['name'] as String?)
          : null,
      profilePicture: profilePicture,
      profileBanner: profileBanner,
      banStatus: banStatus,
      createdAt: json['createdAt'] != null
          ? UserDateTime.fromJson(json['createdAt'] as String?)
          : null,
      updatedAt: json['updatedAt'] != null
          ? UserDateTime.fromJson(json['updatedAt'] as String?)
          : null,
    );
  }
  ...
  factory UserModel.fromJwt(Map<String, dynamic> payload) {
    ...
    return UserModel(
      ...
      userName: payload['username'] != null
          ? UserName.fromJson(payload['username'] as String)
          : null,
      name: payload['name'] != null
          ? UserDisplayName.fromJson(payload['name'] as String)
          : null,
      profilePicture: null,
      profileBanner: null,
      banStatus: null,
  ...
  String get displayName =>
      name?.value ?? userName?.value ?? email.value.split('@')[0];
}
